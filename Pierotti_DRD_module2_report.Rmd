...
A total of 29388 probes have a p-value lower than 0.05 without multiple test correction, while there are no significant probes after either Bonferroni or BH correction.
I will also add the multiple-testing-corrected p-values to the beta values and p-values data frame.
