...
I can observe that the distribution of beta (in the boxplots) values is almost identical across samples for the normalized data, while it is more variable for the raw data. Only the median in the normalized data seems to differ slightly among samples.
...
I observe that there are no significant differences among `DS` and `WT` samples regarding the distribution of mean beta values for probes on chromosome 21.
